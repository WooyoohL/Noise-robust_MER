...
cmd="python train_miss.py --dataset_mode=multimodal_miss --model=NMER
--log_dir=./log/mrcn --checkpoints_dir=./checkpoint/mrcn --gpu_ids=$gpu --image_dir=./shared_image
...
--output_dim=4 --cls_layers=128,128 --dropout_rate=0.1  --noise_type=Gaussian
